...
public class BookToView {
	public BookToView() {
		...
		JFreeChart chart = ChartFactory.createBarChart3D("本年度各月份销量额", "月份", "销售额", dataset, PlotOrientation.VERTICAL,
				true, true, true);
		ChartFrame cf = new ChartFrame("本年度各月份销量额", chart, true);
